...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get personalizeYourExperience => 'تخصيص تجربتك';

  @override
  String get intro =>
      'اختر المظهر واللغة المفضلة لديك لتبدأ بتجربة مريحة ومصممة خصيصًا تناسب أسلوبك.';
  ...
  @override
  String get intro1Title => 'اعثر على الفعاليات التي تلهمك';

  @override
  String get intro1Subtitle =>
      'انغمس في عالم من الفعاليات المصممة لتناسب اهتماماتك الفريدة!\nسواء كنت مهتماً بالموسيقى الحية، أو ورش العمل الفنية، أو التواصل المهني، أو ببساطة اكتشاف تجارب جديدة، فلدينا شيء للجميع. ستساعدك توصياتنا المنسقة على الاستكشاف والتواصل والاستفادة القصوى من كل فرصة حولك.';

  @override
  String get intro2Title => 'تخطيط سهل للفعاليات';

  @override
  String get intro2Subtitle =>
      'تخلص من عناء تنظيم الفعاليات باستخدام أدوات التخطيط الشاملة لدينا!\nبدءاً من إعداد الدعوات وإدارة تأكيدات الحضور (RSVPs) وحتى جدولة التذكيرات وتنسيق التفاصيل، نحن نوفر لك كل ما تحتاجه. خطط بسهولة وركز على الأهم - إنشاء تجربة لا تُنسى لك ولضيوفك.';

  @override
  String get intro3Title => 'تواصل مع الأصدقاء وشارك اللحظات';
